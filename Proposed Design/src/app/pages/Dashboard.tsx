      ...
      <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Let's keep building your strength and wellness.</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#0f0f0f] rounded-2xl border border-white/10 p-6">
                ...
                <div className="space-y-3">
                  <Link
                    to="/tips"
                    className="flex items-center gap-3 p-3 bg-[#1a1a1a] rounded-lg hover:bg-[#1a1a1a]/70 transition-colors"
                  >
