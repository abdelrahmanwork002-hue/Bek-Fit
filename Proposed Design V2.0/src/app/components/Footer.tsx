        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/home" className="text-gray-600 dark:text-gray-400 hover:text-[#6dccc4] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/nutrition" className="text-gray-600 dark:text-gray-400 hover:text-[#6dccc4] transition-colors">
                  Nutrition
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-600 dark:text-gray-400 hover:text-[#6dccc4] transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-600 dark:text-gray-400 hover:text-[#6dccc4] transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
