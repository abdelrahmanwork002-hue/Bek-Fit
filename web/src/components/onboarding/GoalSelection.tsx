...
export function GoalSelection({ data, onNext }: GoalSelectionProps) {
  ...
  return (
    <div>
      <h2 className="text-3xl font-semibold mb-2">What's Your Primary Goal?</h2>
        ...
        {goals.map((goal) => {
          ...
          return (
            ...
            >
              ...
              />
              <h3 className="text-xl font-medium mb-2">{goal.name}</h3>
      ...
      <button
        ...
        className="w-full px-6 py-4 bg-primary text-primary-foreground rounded-xl font-medium text-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Continue
      </button>
    </div>
